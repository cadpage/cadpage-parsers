...
public class OHMahoningCountyCParser extends DispatchA19Parser {
  ...
  public String getFilter() {
    return "noreply@canfield.local,noreply@boardman.gov,@alert.active911.com,cadnotification@flex.comS,dispatch@mahoningcountyoh.gov,ssinn@austintowntwp.com";
  }
