...
public class TXBrazosCountyAParser extends FieldProgramParser {
  public TXBrazosCountyAParser() {
  ...
  public boolean parseMsg(String subject, String body, Data data) {
    if (!subject.equals("Dispatch Call Notes") &&
        !subject.equals("Emergency Management CAD Notification")) return false;
