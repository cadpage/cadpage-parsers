...
public class DispatchOSSIParser extends FieldProgramParser {
  ...
  private static final Pattern CANCEL_PTN = Pattern.compile("(?:\\{([A-Z0-9]+)\\} *)?(CANCEL\\b.*|CODE RED|CONFIRMED FIRE.*|EASTCARE CANCELLED|EASTCARE STANDBY|ELECTRIC UTILITIES|FIRE OUT|FIRE UNDER CONTROL|GAS WATER ELECTRIC|INVESTIGATOR NOTIFIED|RED CROSS|STAGING IN THE AREA|UNDER CONTROL|UNITS RESPOND CODE 1|UTILITY GAS|WORKING INCIDENT|WORKING FIRE)");
