...
public class PAClarionCountyGParser extends FieldProgramParser {
  ...
  public PAClarionCountyGParser() {
    super("CLARION COUNTY", "PA", 
          "Alert_Code:SRC! Address:ADDRCITY! Type:CALL! Xstreets:X Narrative:INFO/N+ Common_Name:PLACE! Loc_Info:APT2! Caller_Name:NAME! Caller_Phone:PHONE! Units:UNIT! GPS:GPS! END");
  }
