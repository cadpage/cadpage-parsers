...
public class DispatchH02Parser extends HtmlProgramParser {
  ...
  public DispatchH02Parser(Properties cityCodes, String defCity, String defState) {
    super(cityCodes, defCity, defState,
          ...
          "| Communications%EMPTY! Dispatch%EMPTY! Incident#:ID! Report#:SKIP! Date:DATE! Time_Out:TIME! Nature:CALL! MP:CODE! Business:PLACE! Address:ADDRCITY! City:CITY " +
    ...
    public void parse(String field, Data data) {
      ...
      if (match.matches()) {
        ...
        if (city.length() > 0 && data.strCity.length() == 0) {
          ...
          if (!city.contains("/")) data.strCity = city;
        }
      }
