...
public class PANorthamptonCountyAParser extends DispatchB2Parser {

  public PANorthamptonCountyAParser() {
  ...
  public String getFilter() {
    return "@notifync.org,14100,12101,777,76993,411912,4702193914,no-reply@ecnalert.com,no-reply@onsolve.com";
  }
