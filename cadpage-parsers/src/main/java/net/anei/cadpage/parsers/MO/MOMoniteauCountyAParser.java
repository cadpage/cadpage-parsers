...
public class MOMoniteauCountyAParser extends FieldProgramParser {

  public MOMoniteauCountyAParser() {
    this("MONITEAU COUNTY", "MO");
  }

  public MOMoniteauCountyAParser(String defCity, String defState) {
