...
public class NCCumberlandCountyAParser extends FieldProgramParser {

  public NCCumberlandCountyAParser() {
    super(NCCumberlandCountyBParser.CITY_CODES, "CUMBERLAND COUNTY", "NC",
