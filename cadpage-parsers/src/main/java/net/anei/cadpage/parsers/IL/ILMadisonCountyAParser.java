...
public class ILMadisonCountyAParser extends DispatchH05Parser {
  ...
  public String getFilter() {
    return "@glen-carbon.il.us,@co.madison.il.us,@troypolice.us,@cityofedwardsville.com,@highlandil.gov,@siue.edu,@collinsvilleil.org,@granitecity.illinois.gov,ripnrun@madisonco.com,@glencarbonil.gov,ripnrun@madisoncountyil.gov";
  }
