...
public class INMarionCountyAParser extends MsgParser {
  
  public INMarionCountyAParser() {
  ...
  private static final Pattern UNIT_PTN =
      Pattern.compile("\\b((?:(?:[A-Z]+[0-9]+[A-Z]?|BC\\d+[A-Z]?|\\d+CIV|\\d+FF|\\d+GRP|[A-Z]+GRP|\\d+TN|\\d+WAY|[A-Z]+FYI|[A-Z]{2}FD|[A-Z]{3}ADM|[A-Z]{2}TF|\\d+ALARM|ALS|AMO|ARSALL|ARSON|BKCREG|BKCRMD|COMM|COMVAN|CISM|DHS|FYI[A-Z]+|CMND|DECSCH|Headquarters|HEMAPG|HINDOT|HMEDIA|IFD[A-Z]+|IFSPOP|INDOT|INVRUNS|IPAGE|IUPAGE|MAJOR|MANPOW|MAYDAY|MEDIA|NONEMG|PVTBLS|PVTMED|RSU|SFDOPS|siit|Station \\d+|STI|type\\d+|WPAGE|WRKFIR|XLFCHF|XLFINV|XLMCOR|WAYVIC|WRTFPK|WRTFWY|(?:IFD|PIK)[A-Z]{1,3}|99\\d|(?:1ST|2ND|3RD)[A-Z]{3})\\b *)+)[\\., ]*(.*)");
