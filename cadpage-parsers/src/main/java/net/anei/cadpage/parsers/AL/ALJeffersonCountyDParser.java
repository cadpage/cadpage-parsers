...
public class ALJeffersonCountyDParser extends FieldProgramParser {
  ...
  private static final Properties CALL_CODES = buildCodeTable(new String[]{
      ...
      "F APL",      "Appliance",
      "F APT",      "Apartment Fire",
      "F ASP",      "Assist Police",
      "F AUPT",     "Vehicle Fire - Person Trapped",
      "F CF",       "Commercial Fire",
      "F COLL",     "Collapse Response/Rescue",
      "F CSR",      "Confined Space Rescue",
      "F DECK",     "Fire in a Parking Deck",
      "F DUMP",     "Dumpster",
      ...
      "F GTLI",     "Grass/Tree/Leaves Interstate",
      "F HAR",      "High Angle Rescue",
      "F HF",       "House Fire",
      "F HFPT",     "House Fire - Person Trapped",
      "F HIGH",     "Highrise Fire",
      ...
      "F IN",       "Smoke/Odor in Area",
      "F INA",      "Fire Alarm Non-MOB - Business/Residential",
      "F INAM",     "Fire Alarm MOB - Hospital/School",
      "F INFS",     "Fuel Spill",
      "F MOBF",     "MOB Fire - Heat/Fire/Smoke",
      "F MUF",      "Mutual Aid - Automatic Aid Fire Request",
      ...
      "M EYE",      "Eye Injury",
      "M FALL",     "Fall",
      "M GSP",      "GSW/Stabbing/Penetrating Trauma",
