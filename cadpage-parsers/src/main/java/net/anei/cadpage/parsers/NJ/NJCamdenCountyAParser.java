...
public class NJCamdenCountyAParser extends DispatchArchonixParser {
  ...
  private static final Properties CALL_CODES = buildCodeTable(new String[] {
      ...
      "20",     "STOLEN CAR",
      "201",    "CARDIAC ARREST",
      "201-E",  "CARDIAC ARREST",
      "201-F",  "CARDIAC ARREST",
      "201-L",  "CARDIAC ARREST",
      "202",    "RESPIRATORY ARREST",
      "202-E",  "RESPIRATORY ARREST",
      "202-F",  "RESPIRATORY ARREST",
      "202-L",  "RESPIRATORY ARREST",
      "203",    "CARDIAC EMERGENCY",
      "203-E",  "CARDIAC EMERGENCY",
      "203-F",  "CARDIAC EMERGENCY",
      "203-L",  "CARDIAC EMERGENCY",
      "204",    "RESPIRATORY EMERG",
      "204-E",  "RESPIRATORY EMERG",
      "204-F",  "RESPIRATORY EMERG",
      "204-L",  "RESPIRATORY EMERG",
      "205",    "UNCONSCIOUS",
      "205-E",  "UNCONSCIOUS",
      "205-F",  "UNCONSCIOUS",
      "205-L",  "UNCONSCIOUS",
      ...
      "213-F",  "SEIZURES",
      "213-L",  "SEIZURES",
      "213B",   "SEIZURE/NON ACTIVE",
      "213B-E", "SEIZURE/NON ACTIVE",
      "213B-F", "SEIZURE/NON ACTIVE",
      "213B-L", "SEIZURE/NON ACTIVE",
      "214",    "ALLERGIC",
      "214-E",  "ALLERGIC",
      "214-F",  "ALLERGIC",
      "214-L",  "ALLERGIC",
      "214B",   "ALLERGIC/MINOR",
      "214B-E", "ALLERGIC/MINOR",
      "214B-F", "ALLERGIC/MINOR",
      "214B-L", "ALLERGIC/MINOR",
      "215",    "OVERDOSE",
      "215-E",  "OVERDOSE",
      "215-F",  "OVERDOSE",
      "215-L",  "OVERDOSE",
      ...
      "221-L",  "MED EMERGENCY",
      "222",    "PSYCH EMERGENCY",
      "222-E",  "PSYCH EMERGENCY",
      "222-F",  "PSYCH EMERGENCY",
      "222-L",  "PSYCH EMERGENCY",
      "223",    "MATERNITY",
      "223-E",  "MATERNITY",
      "223-F",  "MATERNITY",
      "223-L",  "MATERNITY",
      ...
      "225-L",  "ASSAULT",
      "226",    "ABDOMINAL PAIN",
      "226-E",  "ABDOMINAL PAIN",
      "226-F",  "ABDOMINAL PAIN",
      "226-L",  "ABDOMINAL PAIN",
      "227",    "FALL VICTIM",
      "227-E",  "FALL VICTIM",
      "227-F",  "FALL VICTIM",
      "227-L",  "FALL VICTIM",
      ...
      "29",     "ALARM",
      "3",      "OFF RADIO",
      "30",     "EMERG OFFICER ASST",
      "31",     "EMERG CLEAR RADIO",
      "32",     "MV STOP NON MOVING",
      "33",     "MV STOP MOVING",
      "34",     "SUSPICIOUS MV STOP",
      "35",     "NOT FOUND",
      "36",     "TELEPHONE CALL",
      "37",     "SWITCH FREQUENCY",
      "38",     "CCCAP",
      ...
      "4",      "OK",
      "40",     "BACK IN SERVICE",
      "41",     "CONDITION AT SCENE",
      "42",     "FATAL",
      "44",     "DISPATCH FIRE  EQP",
      "45",     "DISP OUT OF SERVIC",
      "46",     "DIRECTED PATROL G",
      "46T",    "DIRECTED PATROL T",
      "47",     "DISABLE MV",
      "48",     "DIRECTED PATROL S",
      "49",     "PROPERTY CHECK",
      "5",      "MEET WITH",
      "50",     "CAN NOT TRANSMIT",
      "51",     "VIOLATION OF RADIO",
      "54",     "TOW TRUCK",
      "55",     "TRAFFIC CONDITION",
      "56",     "DISPATCH AMBULANCE",
      "57",     "COMM POLICING",
      "58",     "D. L. CHECK",
      "59",     "MV LOOK UP",
      "6",      "UNDER CONTROL",
      ...
      "83",     "SEARCH",
      "84",     "CHECK PERSON",
      "85",     "ASSAULT NOT PRGRS",
      "86",     "REMOVAL",
      "87",     "FOLLOW UP COMPLAINT",
      "9",      "STAND BY",
      "98",     "911 LOG",
      "99",     "ALERT",
      "998",    "TEST POLICE CALL",
      "999",    "TEST F&A",
      "999-E",  "TEST EMS",
      "999-F",  "TEST FIRE",
      "A",      "DWELLING",
      ...
      "A-F",    "DWELLING",
      "A-L",    "DWELLING",
      "AA",     "APPARATUS ACCIDENT",
      "AA-E",   "APPARATUS ACCIDENT",
      "AA-F",   "APPARATUS ACCIDENT",
      "AA-L",   "APPARATUS ACCIDENT",
      "AC",     "COMMERCIAL AIRCRAFT",
      "AC-E",   "COMMERCIAL AIRCRAFT",
      "AC-F",   "COMMERCIAL AIRCRFT",
      "AC-L",   "COMMERCIAL AIRCRAFT",
      "AM",     "MINOR AIRCRAFT",
      "AM-E",   "MINOR AIRCRAFT",
      "AM-F",   "MINOR AIRCRAFT",
      "AM-L",   "MINOR AIRCRAFT",
      "AP",     "PRIVATE AIRCRAFT",
      "AP-E",   "PRIVATE AIRCRAFT",
      "AP-F",   "PRIVATE AIRCRAFT",
      "AP-L",   "PRIVATE AIRCRAFT",
      "AR",     "ANIMAL RESCUE",
      "AR-E",   "ANIMAL RESCUE",
      "AR-F",   "ANIMAL RESCUE",
      "AR-L",   "ANIMAL RESCUE",
      ...
      "HMI-F",  "HAZMAT INVEST",
      "HMI-L",  "HAZMAT INVEST",
      "HMZ",    "HAZMAT INSPECTIONS",
      "HMZ-F",  "HAZMAT INSPECTIONS",
      "HMZ-L",  "HAZMAT INSPECTIONS",
      "I",      "INCIDENTAL",
      "I-E",    "INCIDENTAL",
      "I-F",    "INCIDENTAL",
      "I-L",    "INCIDENTAL",
      "IA",     "INVEST/AP/AL/HEAT",
      "IA-E",   "INVEST/AP/AL/HEAT",
      "IA-F",   "INVEST/AP/AL/HEAT",
      "IA-L",   "INVEST/AP/AL/HEAT",
      "IF",     "INTERIOR FUMES",
      "IF-E",   "INTERIOR FUMES",
      "IF-F",   "INTERIOR FUMES",
      "IF-L",   "INTERIOR FUMES",
      ...
      "K-L",    "WATER RESCUE",
      "KS",     "RESCUE POOL/POND",
      "KS-E",   "RESCUE POOL/POND",
      "KS-F",   "RESCUE POOL/POND",
      "KS-L",   "RESCUE POOL/POND",
      "KV",     "OCC VEHL IN WATER",
      "KV-E",   "OCC VEHL IN WATER",
      "KV-F",   "OCC VEHL IN WATER",
      "KV-L",   "OCC VEHL IN WATER",
      "L",      "RESCUE",
      "L-E",    "RESCUE",
      "L-F",    "RESCUE",
      "L-L",    "RESCUE",
      ...
      "N-L",    "HAZ MAT",
      "NG",     "NAT GAS RELEASE",
      "NG-E",   "NAT GAS RELEASE",
      "NG-F",   "NAT GAS RELEASE",
      "NG-L",   "NAT GAS RELEASE",
      "O",      "MISC",
      "O-F",    "MISC",
      "O-L",    "MISC",
      "OB",     "SHED/OUTER BLDG",
      "OB-E",   "SHED/OUTER BLDG",
      "OB-F",   "SHED/OUTER BLDG",
      "OB-L",   "SHED/OUTER BLDG ",
      "P",      "MVA",
      "P-E",    "MVA",
      "P-F",    "MVA",
      "P-L",    "MVA",
      ...
      "Q-L",    "EMS ASSIST",
      "R-F",    "RELOCATE",
      "RR",     "RAILROAD INCIDENT",
      "RR-E",   "RAILROAD INCIDENT",
      "RR-F",   "RAILROAD INCIDENT",
      "RR-L",   "RAILROAD INCIDENT",
      "S",      "SPARKING OUTLET",
      "S-E",    "SPARKING OUTLET",
      "S-F",    "SPARKING OUTLET",
      "S-L",    "SPARKING OUTLET",
