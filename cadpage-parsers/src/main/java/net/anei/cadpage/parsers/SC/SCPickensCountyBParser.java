...
public class SCPickensCountyBParser extends FieldProgramParser {
  ...
  public SCPickensCountyBParser() {
    super("PICKENS COUNTY", "SC", 
          "Location:ADDRCITY! Common_Name:PLACE? ( Location_info:X! | Common_Location:X! ) CAD_Code:ID! Received:SKIP! Units:UNIT! Priority:PRI? Box_Alarm:BOX? Caller_Name:NAME? Caller:PHONE? Contact:SKIP? Case_Number:ID/L! Notes:INFO/N+");
