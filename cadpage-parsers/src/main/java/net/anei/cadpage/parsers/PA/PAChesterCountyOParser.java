...
public class PAChesterCountyOParser extends PAChesterCountyBaseParser {
  ...
  public String getFilter() {
    return "gfac55calls@gmail.com,EWFC05@verizon.net,pfdfire@fdcms.info,vfvfco168@comcast.net,westwoodfire@comcast.net,cad@oxfordfire.com,afc23@fdcms.info,whcems@gmail.com,paging@eastwhitelandfire.org";
  }
