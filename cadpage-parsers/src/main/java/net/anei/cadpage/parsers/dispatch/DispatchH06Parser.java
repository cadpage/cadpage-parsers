...
public class DispatchH06Parser extends DispatchH05Parser {

  public DispatchH06Parser(String defCity, String defState) {
    super(defCity, defState,
          "MARKER! CFS_Number:SKIP! Report_Date/Time:SKIP! Call_Date/Time:SKIP? Call_Address:ADDRCITY! Call_Taker:SKIP! Police_Dispatchers:SKIP! " +
          ...
          "Google_Maps_Hyperlink:SKIP! Cross_Streets:X! Latitude:GPS1! Longitude:GPS2! Local_Information:INFO! Custom_Layer:LINFO! Census_Tract:LINFO " +
  ...
  public Field getField(String name) {
    if (name.equals("MARKER")) return new SkipField("(?:Final )?Rip and Run Report", true);
