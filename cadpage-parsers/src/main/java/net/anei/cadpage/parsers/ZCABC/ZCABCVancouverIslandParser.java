...
public class ZCABCVancouverIslandParser extends FieldProgramParser {
  ...
  private static final Pattern SRC_PTN = Pattern.compile("(ARRAS|BEAVER CREEK|CAMPBELL RIVER|CHERRY CREEK|CHETWYND|COWICHAN BAY|COMOX|COURTENAY|COWICHAN TRIBES|CUMBERLAND|DAWSON CREEK|DENMAN ISLAND|DUNCAN|FANNY BAY|GOLD RIVER|HORNBY ISLAND|LADYSMITH|LAKE COWICHAN|MALAHAT|MILL BAY|MOBERLY LAKE|NORTH COWICHAN(?: FIRE DEPARTMENT)?|NORTH OYSTER|OYSTER RIVER|POUCE COUPE|PT ALBERNI|PT HARDY|SHIPS POINT|SOINTULA|SPROAT LAKE|TAHSIS|TAYLOR|TOFINO|TOMSLAKE|TUMBLER RIDGE|UCLUELET|UNION BAY|YUU-THLU-ILTH-AHT) *(.*)");
  ...
  private static final CodeSet CALL_LIST = new CodeSet(
      ...
      "FIRST RESP DELAY ORANGE",
      "FIRST RESP DELAY PURPLE",
      "FIRST RESP DELAY RED",
      "FIRST RESP DELAY YELLOW",
      "FIRST RESP RED",
      "FIRST RESP E",
      "FIRST RESP RED",
      "FIRST RESP ORANGE",
