...
public class KSDickinsonCountyParser extends DispatchH05Parser {
  ...
  public KSDickinsonCountyParser() {
    super("DICKINSON COUNTY", "KS",
          "CFS_NUMBER? CASE_NUMBER CALL_TIME CALLER_NAME? CALLER_PHONE? ADDRESS NATURE INITIAL_DISPATCH_TIME? ( UNITS! | NARRATIVE INFO_BLK/Z+? UNITS! ) STATUS_TIMES? TIMES/Z+? NARRATIVE INFO_BLK+? TIMES");
  }
