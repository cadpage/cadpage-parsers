...
public class Active911ParserTable {
  ...
  static final Properties POLY_CODE_TABLE = MsgParser.buildCodeTable(new String[]{
      ...
      "US/AL/MadCo911",                   "ALMadisonCountyC",
      "US/AL/MadisonCounty",              "ALMadisonCountyC,ALMadisonCountyE",
      "US/IN/MadisonCountyLapel",         "ALMadisonCountyC", 
      ...
      "US/SC/GreenvilleCountyCAD",        "SCGreenvilleCounty",
