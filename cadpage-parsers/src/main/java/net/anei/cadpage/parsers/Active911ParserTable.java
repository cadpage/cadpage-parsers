...
public class Active911ParserTable {
  ...
  static final Properties POLY_CODE_TABLE = MsgParser.buildCodeTable(new String[]{
      ...
      "US/SC/FountainInn",                "SCGreenvilleCountyD",
      "US/SC/GeorgetownCounty",           "SCGeorgetownCounty",
      "US/SC/GreenvilleCounty",           "SCGreenvilleCountyB,SCGreenvilleCountyD",
      "US/SC/GreenvilleCountyCAD",        "SCGreenvilleCountyB,SCGreenvilleCountyD",
