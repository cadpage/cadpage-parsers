...
public class TXCollinCountyCParser extends DispatchA82Parser {
  ...
  public String getFilter() {
    return "icsuser@co.collin.tx.us,ccsodispatch@co.collin.tx.us,inforad@co.walker.tx.us,prosperdispatch@prospertx.gov,ispage@murphytx.org,CADPaging-NOREPLY@flower-mound.com,notifications@athenaics.com";
  }
