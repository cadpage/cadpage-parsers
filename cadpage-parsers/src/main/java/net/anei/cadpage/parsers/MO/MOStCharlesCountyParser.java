...
public class MOStCharlesCountyParser extends FieldProgramParser {
  ...
  private static final CodeSet CALL_LIST = new CodeSet(
      ...
      "Allergy Hives or Rash",
      "Allergy Reaction Unk",
      "Allergy Severe Histor",
      "Alert Diff Breathing",
      "Animal Bite Not Dange",
      ...
      "BP Diagnosed Aneurysm",
      "BP Diff Breathing",
      "BP Suspected Aneurysm",
      "BRSH FRE bravo",
      "BRUSH FIRE unknown",
      "BSH FRE small",
      "Building Collapse",
      ...
      "Chest/Neck Inj Diff B",
      "Choking Ineffect Bre",
      "Choking Ineffect Brea",
      "Choking Not Alert",
      "Choking Partial Bloc",
      "Choking Partial Block",
      "Citizen Assist",
      "Citizen Assist Unk",
      "Commercial Alarm",
      "Commercial Alrm",
      ...
      "Fall Not Alert",
      "Fall Not Dangerous",
      "Fall Poss Danger/Fain",
      "Fall Possibly Danger",
      "Fall Possibly Dangero",
      "Fall Possibly Dangerous",
      "Fall Unconscious",
      "Fall Unknown",
      "Fire - Boat Docked/Thrt",
      "Fire - Comm",
      "Fire - Comm Smoke Odor",
      "Fire - Outside",
      "Fire - Outside Large",
      "Fire - Outside Threaten",
      "Fire - Outside Threatening",
      "Fire - Resd",
      "Fire - Resd Electrical",
      "Fire - Resd Smoke Odor",
      "Fire - Resd Trapped",
      "Fire - Resd Appliance",
      "Fire - Resd Chimney",
      "Fire - Veh",
      ...
      "Headache Breath Norma",
      "Headache Not Alert",
      "Headache Numbness",
      "Headache Sudden Onset",
      "Heart Prob Abnrmal Br",
      "Heart Problem Cardiac",
      "Heart Problem Diff Br",
      "Heart Prob Rate -50/",
      "Heart Problems Charli",
      "Heart Problems Not Al",
      "Heart Problem Unk Sta",
      "Heat EXP Heart Attack",
      "Heat EXP Not Alert",
      "Heat EXP Unknown Stat",
      "Heat Exposure Alert",
      "Heat Exposure Alpha",
      ...
      "OD Not Alert Fentany",
      "OD Not Alert Fentanyl",
      "OD Uncon Fentanyl",
      "OD Unk Fentanyl",
      "Odor Investigation",
      "Outside Fire",
      ...
      "Seizures Pregnancy",
      "Seizures Charlie",
      "Seizures Not Breathin",
      "Seizure Stopped No Hx",
      "Seizure Stopped Seiz",
      "Seizure Stopped Seiz Hx",
