...
public class DispatchProphoenixParser extends FieldProgramParser {
  ...
  public DispatchProphoenixParser(Properties cityCodes, String[] cityList, String defCity, String defState) {
    super(cityList, defCity, defState,
          ...
          "| DATETIME ( CALLADDR/Z! Latitude:GPS1! | CALL ADDR! Latitude:GPS1 ) Longitude:GPS2 CrossStreet1:X CrossStreet2:X CommonName:PLACE Units:UNIT/S+ Comments:INFO+ )");
  ...
  public Field getField(String name) {
    ...
    if (name.equals("CALLADDR")) return new BaseCallAddressField();
  ...
  private class BaseCallAddressField extends BaseAddressField {
    @Override
    public void parse(String field, Data data) {
