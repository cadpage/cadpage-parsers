...
public class OHCuyahogaCountyAParser extends DispatchA39Parser {
  ...
  public String getFilter() {
    return "dispatch@chagrinfallspd.com,dispatcher@bhpd.org,dispatch@secc-911.org,PRDC@parma.com,dispatch@waltonhillsohio.gov,@cox.net,PRDC@parmajustice.net";
  }
