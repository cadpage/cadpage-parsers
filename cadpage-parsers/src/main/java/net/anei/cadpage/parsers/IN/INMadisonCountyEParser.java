...
public class INMadisonCountyEParser extends DispatchH05Parser {
  ...
  public INMadisonCountyEParser() {
    super("MADISON COUNTY", "IN", 
          "DATE:DATETIME! CFS#:SKIP? PLACE:PLACE! ADDR:ADDRCITY! CROSS_STREETS:X! STARS! CALL:CALL! STARS! UNIT:UNIT! STARS! INFO:INFO! STARS! FIRE_RD:CH! STARS! ( CAD_#:ID! STARS! | ) GPS_LAT:GPS1! GPS_LON:GPS2! HASHES! NARRATIVE:SKIP INFO_BLK+? TIMES:SKIP TIMES+");
  }
